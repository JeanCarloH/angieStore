          ...
          <div className="flex flex-col lg:flex-col gap-10 w-full">
            <div className="flex-1 lg:w-[500px] space-y-4 lg:pl-10 xl:pl-10">
              <div className="flex flex-col w-full p-10 gap-4 bg-white rounded-xl shadow-lg ">
                ...
                <p className="text-gray-600">{product && product.availability} disponibles
                </p>
            ...
            <SheetContent side="right" className="w-80 p-5">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  {/* Botón "Ir a Pagar" */}
                  <Button className="w-full mt-6 bg-black text-white py-3 rounded-lg hover:bg-gray-900 transition" onClick={botonComprarAhora}>
                    Ir a Pagar
                  </Button>
                </>
              )}
